...
\newenvironment{pagesol}[2][]{
	...
	\begin{center}
		\ifodd#2
			\includegraphics[page=#2, scale=0.8, trim={1cm 2cm 1cm 1.8cm}, clip, frame]{./output-student/llibre-3eso-student.pdf}
		\else
			\includegraphics[page=#2, scale=0.8, trim={1cm 2cm 1cm 1.8cm}, clip, frame]{./output-student/llibre-3eso-student.pdf}
		\fi
	\end{center}
...
\def\nonotes{#1}
\includepdf[pages=#2]{./output-student/llibre-3eso-student.pdf}
\newpage
...
\begin{document}
	...
	\includepdf[pages=1]{./output-student/llibre-3eso-student.pdf}

	\includepdf[pages=2]{./output-student/llibre-3eso-student.pdf}

	\includepdf[pages=3]{./output-student/llibre-3eso-student.pdf}

	\includepdf[pages=4]{./output-student/llibre-3eso-student.pdf}

	\includepdf[pages=5]{./output-student/llibre-3eso-student.pdf}

	\includepdf[pages=6]{./output-student/llibre-3eso-student.pdf}

	\includepdf[pages=7]{./output-student/llibre-3eso-student.pdf}

	\includepdf[pages=8]{./output-student/llibre-3eso-student.pdf}

	\includepdf[pages=9]{./output-student/llibre-3eso-student.pdf}
...
\displaynotes
	...
	\includepdf[pages=22]{./output-student/llibre-3eso-student.pdf}

	\includepdf[pages=23]{./output-student/llibre-3eso-student.pdf}
...
\newpage
	...
	\includepdf[pages=35]{./output-student/llibre-3eso-student.pdf}
\newpage
\pagexxxiii
\newpage
...
\displaynotes
	...
	\includepdf[pages=45]{./output-student/llibre-3eso-student.pdf}
\newpage
\pagexliii
\newpage
...
\displaynotes
	...
	\includepdf[pages=49]{./output-student/llibre-3eso-student.pdf}
\newpage
\pagexlvii
\newpage
...
\displaynotes
	...
	\includepdf[pages=61]{./output-student/llibre-3eso-student.pdf}
\newpage
\pagelix
\newpage
...
\displaynotes
	...
	\includepdf[pages=77]{./output-student/llibre-3eso-student.pdf}
\newpage
\pagelxxv
\newpage
...
\displaynotes
	...
	\includepdf[pages=87]{./output-student/llibre-3eso-student.pdf}
\newpage
\pagelxxxv
\newpage
...
\displaynotes
	...
	\includepdf[pages=93]{./output-student/llibre-3eso-student.pdf}
\newpage
\pagexci
\newpage
...
\displaynotes
	...
	\includepdf[pages=103]{./output-student/llibre-3eso-student.pdf}
...
\displaynotes
	...
	\includepdf[pages=114]{./output-student/llibre-3eso-student.pdf}

	\includepdf[pages=115]{./output-student/llibre-3eso-student.pdf}
...
\displaynotes
	...
	\includepdf[pages=129]{./output-student/llibre-3eso-student.pdf}
\newpage
\pagecxxvii
\newpage
...
\displaynotes
	...
	\includepdf[pages=141]{./output-student/llibre-3eso-student.pdf}
\newpage
\pagecxxxix
\newpage
...
\displaynotes
	...
	\includepdf[pages=155]{./output-student/llibre-3eso-student.pdf}

	\includepdf[pages=156]{./output-student/llibre-3eso-student.pdf}

	\includepdf[pages=157]{./output-student/llibre-3eso-student.pdf}
\newpage
\pageclv
\newpage
