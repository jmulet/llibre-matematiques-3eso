...
\end{blueshaded}
 ...
 \includegraphics[width=0.9\textwidth]{img2/portada}
...
\begin{center}
	\includegraphics*[width=1.2in]{img2/ies-binissalem-logo}
 ...
 \begin{center}
 	\begin{minipage}{0.5\textwidth}
 		Aquesta és una obra derivada de ``\textit{Matematicas 3º de ESO. Ejercicios y problemas}'' de Marea Verde de matemàtiques. Per tant, està subjecta a les mateixes condicions de llicència CREATIVE COMMONS que l'obra original.
 		 ...
 		 \noindent \textbf{Versió}: \quad 2017-07-16
 		 
 		 \noindent \textbf{Portada}: \quad \textit{Desenvolupament d'un dodecaedre}.
 		 
 		
 		\begin{center}
 		\includegraphics*[width=8cm]{img2/licencia}
 		\end{center}
 	\end{minipage}
 \end{center}
...
\vspace*{\fill}
\begin{center}
	\includegraphics[width=\textwidth]{img2/resolucio-problemes}
\end{center}
\vspace*{\fill}
...
\begin{longtable}[h]{>{\raggedleft\arraybackslash}p{0.19\textwidth}|p{0.78\textwidth}}
	...
	\begin{center}\includegraphics[width=1cm]{img2/video-132}\par {\footnotesize Vídeo 132:}\end{center} & Explicació en vídeo dels continguts de l'apartat. El número de vídeo correspon a la numeració emprada en https://piworld.es 
...
\begin{longtable}[h]{>{\raggedleft\arraybackslash}p{0.2\textwidth}|p{0.8\textwidth}}
	...
	\includegraphics[height=1.5cm]{img2/piworld}
	...
	\\ \hline
 	...
 	\includegraphics[height=1.5cm]{img2/geogebra}
 	...
 	\href{https://www.geogebra.org/download}{\href{https://www.geogebra.org/graphing}{https://www.geogebra.org/graphing}}
 	  \\ \hline
 	  	...
 	  	\includegraphics[height=2cm]{img2/wiris}
