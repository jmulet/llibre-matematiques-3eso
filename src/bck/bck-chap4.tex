 ...
 \mychapter{Estadística i Probabilitat}{Estadística i Probabilitat}{\includegraphics[width=4.5cm]{img4/icono}}{chap:estadistica}
...
\begin{minipage}{0.3\textwidth}
	\centering
	\includegraphics[width=0.9\textwidth]{img4/mostra}
\end{minipage}
...
\begin{center}
\boxed{\includegraphics[width=0.9\textwidth]{img4/grafics}}
\end{center}
...
\begin{minipage}{0.4\textwidth} 
	\centering
	\includegraphics[width=\textwidth]{img4/histo2}
\end{minipage}
\end{center}
	...
	\begin{resolt}{En un barri s'ha trobat que les famílies residents s'han distribuït, segons el número de membres, de la forma següent:\vspace{0.25cm}
		...
		\begin{wrapfigure}{R}{0.3\textwidth} 
			\vspace{-0.75cm}
			\begin{center}
				\includegraphics[width=0.26\textwidth]{img4/histo1}
			\end{center}
			\vspace{-0.5cm}
		\end{wrapfigure}
...
\answers{$M_o =1$; $\bar x=1.6$; $Var=0.84$; $\sigma=0.92$}
...
\answers{Variable quantitativa discreta;\par $\bar x=1.6078$; $\sigma=0.9717$}
...
\answers{$\bar x=0.95$; $M_e=0.8$; $M_o=1$}
 
\exer Amb les dades del problema anterior calcula el rang, la desviació mitjana, la variància i la desviació típica. 


\answers{Rang = 4. Desviació mitjana = 0,456. Variança = 0,299. Desviació típica = 0,5473; $M_e$ = 1; $Q_1 = 1$; $Q_3= 1$.}
...
\answers{[Mitjana = 2.5; Mediana = 2; Moda = 2, \includegraphics[width=0.35\textwidth]{img-sol/t4-13}]}
...
\end{tasks}
 ...
 \answers{[$\bar x=93.8$; $\sigma=13.3$; $CV=0.142$,  62.4 \%]}
...
Talla & 1,50 -- 1,56 & 1,56 -- 1,62 & 1,62 -- 1,68 & 1,68 - 1,74 & 1,74 - 1,80 & 1,80-1,92 \\ \hline 
...
\answers{[\includegraphics[width=0.35\textwidth]{img-sol/t4-15},
		Mitjana = 1,7049. Desviació típica =0.076692,
Mediana. Para calcular l'interval on es troba miram, en
 la taula de les freqüències acumulades, estan els 500 soldats. És l'interval 1,68 – 1,74.
 ]}
...
\answers{Es pot representar mitjançant un diagrama de barres amb colors diferents per a cada any. La variable és
	...
	Itàlia $>$ Grècia $>$ Espanya $>$ Alemanya $>$ França $>$ Portugal $>$ Regne Unit.}
...
\answers{ 
	...
	Vots en blanc=
	1,1583\%; \par
	Ha guanyat l'abstenció, amb més de la meitat del cens.}
...
\begin{minipage}{0.3\textwidth}
	\vspace{2cm}
	\centering
	\includegraphics[width=0.7\textwidth]{img4/monedes}
\end{minipage}
...
\vspace{2cm}
\centering
\includegraphics[width=0.8\textwidth]{img4/xinxetes}
\end{minipage}
...
\begin{longtable}{p{1.5in}p{1.2in}p{1.2in}} 
	\centering 
a) Dau cúbic (6 cares)\newline \includegraphics*[bb=0 0 0.66in 0.70in, width=0.66in, height=0.70in, keepaspectratio=false]{img4/image3.png} & b) Dau tetraèdric (4 cares)\newline \includegraphics*[bb=0 0 0.73in 0.74in, width=0.73in, height=0.74in, keepaspectratio=false]{img4/image4.png} & c) Dau octaèdric (8 cares)\newline \includegraphics*[bb=0 0 1.13in 0.89in, width=0.78in, height=0.76in, keepaspectratio=false, trim=0.31in 0.04in 0.04in 0.09in]{img4/image5.png} \\ [0.5cm] \quad P(2) = ........ & \quad P(2) =......... & \quad P(2)=.......... \\  [0.2cm] \quad P(5) = ........ & \quad P(5) =......... & \quad P(5).......... \\
\end{longtable}
...
\end{tasks}
\answers{[$\frac{4}{20}$, $\frac{19}{20}$, $\frac{13}{20}$, $\frac{11}{20}$]}
 

\exer  Raona de quina de les bosses següents és més probable treure una bola negra:
\begin{center}
 \includegraphics*[  width=2.91in ]{img4/image6.png}
\end{center}
...
\begin{center}
	\includegraphics[width=5cm]{img4/image11}
\end{center}
\begin{tasks} 
...
\begin{resolt}[E]{
	...
	\begin{center}
	\includegraphics[width=4.5cm]{img4/arbre}
	\end{center}
...
\begin{minipage}{0.15\textwidth}
	\centering
	\includegraphics[width=0.7\textwidth]{img4/incendi}
\end{minipage}
...
\begin{minipage}{0.29\textwidth}
	\centering
	\includegraphics[width=0.94\textwidth]{img4/calcetins}
\end{minipage}
