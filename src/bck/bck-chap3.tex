\mychapter{Successions i progressions}{Successions i progressions}{\includegraphics[width=4.3cm]{img3/nautilus}}{chap:successions}
...
\addanswersline[cols=1]{Avaluació inicial}{0}{[Successió dels nombres senars: $1,3,5,7,9,11,13,15,\cdots$, Multiplicam per --2: $2,-4,8,-16,32,-64,128,-256,\cdots$, Successió dels quadrats: $1,4,9,16,25,36,49,64,81,\cdots$ ]}
\end{iniaval}
...
\begin{minipage}{0.16\textwidth}
	\centering
	\includegraphics[width=0.8\textwidth]{img3/satellite}
\end{minipage}
...
\begin{center}
	\includegraphics[height=2cm]{img3/quadrats}
\end{center}
...
\textit{Triangle de Sierpinski}: Anem a construir un fractal. Es parteix d'un triangle equilàter. S'uneixen els punts mitjans dels costats i es formen quatre triangles. S'elimina el triangle central. En cadascun dels altres tres triangles es repeteix el procés. I així successivament. A la figura formada per iteració infinita la hi denomina Triangle de Sierpinski, i és un fractal.
 	\begin{center}
	\includegraphics*[width=0.38\textwidth]{img3/sierpinski}
\end{center} 
...
\answers{Progressió geomètrica $a_{n} = 2·5^{n-1}$  }
...
\begin{blueshaded}
	...
	\begin{center}
		\includegraphics[height=3cm]{img3/espiral.png}
		\includegraphics[height=3cm]{img3/nautilus2.jpg}
	\end{center}
