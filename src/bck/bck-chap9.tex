\mychapter{Geometria en el pla}{Geometria en el pla}{\begin{center}\includegraphics[width=0.9\textwidth]{img9/pitagoras} \footnotesize Demostració del teorema de Pitàgores\end{center}}{chap:geo2d}
...
\begin{iniaval}
	...
	\begin{minipage}{0.4\textwidth}
		\centering
			\includegraphics[width=\textwidth]{img9/ampliacio1}
	\end{minipage}
	 ...
	 \begin{minipage}{0.35\textwidth}
	 	\centering
	 	\includegraphics[width=0.9\textwidth]{img9/ampliacio2}
	 \end{minipage}
	 \vsoo
...
\begin{theorybox}
	\begin{wrapfigure}{R}{0.3\textwidth}
		\centering
			\includegraphics[width=0.28\textwidth]{img9/trig-semblant}
	\end{wrapfigure}
...
\begin{resolt}[E]{
	...
	\begin{center}
		\includegraphics[width=0.2\textwidth]{img9/sampleTales}
	\end{center}	
...
\begin{tasks}(2)
	\task   \includegraphics[width=0.3\textwidth]{img9/trig-semblant2}
	\task    \includegraphics[width=0.35\textwidth]{img9/trig-semblant5}
\end{tasks}
...
\begin{tasks}(2)
	\task    \includegraphics[width=0.35\textwidth]{img9/trig-semblant3}
	\task   \includegraphics[width=0.4\textwidth]{img9/trig-semblant4}
\end{tasks}
...
\begin{minipage}{0.4\textwidth}
	\centering
	\includegraphics[width=0.8\textwidth]{img9/pitagores}
\end{minipage}
...
\begin{center}
 \includegraphics[width=0.2\textwidth]{img9/fig6}
\end{center}
\answers{$x=8$ cm}
...
\begin{minipage}{0.3\textwidth}
	\centering
	\vspace{1.5cm}
\includegraphics[width=0.8\textwidth]{img9/fig7}
\end{minipage}
...
\begin{minipage}{0.3\textwidth}
	\centering
	\vspace{1.5cm}
\includegraphics[width=0.7\textwidth]{img9/fig8}
\end{minipage}
...
\begin{center}
	\includegraphics[width=0.2\textwidth]{img9/fig9}
\end{center}
...
\begin{minipage}{0.3\textwidth}
	\centering
	\vspace{2cm}
	\includegraphics[width=0.6\textwidth]{img9/fig10}
\end{minipage}
...
\answers{En general $\frac{R^2}{2}(\pi - \sqrt{3})=1.41$ m$^2$}
 ...
 \begin{minipage}{0.3\textwidth}
 	\centering
 	\vspace{1.5cm}
 	\includegraphics[width=0.5\textwidth]{img9/fig11}
 \end{minipage}
...
\begin{minipage}{0.3\textwidth}
	\centering
	\vspace{1.5cm}
	\includegraphics[width=0.5\textwidth]{img9/fig12}
\end{minipage}
...
\begin{minipage}{0.3\textwidth}
	\centering
	\vspace{1.5cm}
	\includegraphics[width=0.5\textwidth]{img9/formatge}
\end{minipage}
...
\begin{minipage}{0.3\textwidth}
	\centering
	\vspace{1.5cm}
	\includegraphics[width=0.7\textwidth]{img9/fig14}
\end{minipage}
...
\begin{minipage}{0.3\textwidth}
	\centering
	\vspace{1.5cm}
	\includegraphics[width=0.99\textwidth]{img9/fig16}
\end{minipage}
 ...
 \begin{minipage}{0.3\textwidth}
 	\centering
 	\vspace{1.5cm}
 	\includegraphics[width=0.6\textwidth]{img9/fig15}
 \end{minipage}
...
\begin{theorybox}
		...
		\begin{multicols}{3}
			...
			\includegraphics[height=2.5cm]{img9/cercle}
			
			Circumferència
			
			\includegraphics[height=2.5cm]{img9/mediatriu}
			
			Mediatriu
			
			\includegraphics[height=2.5cm]{img9/bisectriu}
...
\begin{theorybox}
	...
	\begin{multicols}{2}
		...
		\includegraphics[height=3.5cm]{img9/circumcentre}
		
		Mediatrius -- Circumcentre
		
		\includegraphics[height=3.5cm]{img9/incentre}
		
		Bisectrius -- Incentre
		
		\includegraphics[height=3.5cm]{img9/baricentre}
		
		Medianes -- Baricentre
		
		
		\includegraphics[height=3.5cm]{img9/ortocentre}
...
\begin{center}
	\includegraphics[width=0.38\textwidth]{img9/fig17}
\end{center}
 ...
 \begin{center}
 	\includegraphics[width=0.38\textwidth]{img9/fig20}
 \end{center}
...
\begin{center}
	\includegraphics[width=6.7cm]{img9/experiment-sol}
\end{center}
\end{mylist}
...
\begin{center}
	\includegraphics[width=0.4\textwidth]{img9/angles}
\end{center}
...
\begin{minipage}{0.15\textwidth}
	\centering
	\vspace{1.5cm}
	\includegraphics[width=0.75\textwidth]{img9/stop}
\end{minipage}
...
\begin{center}
	\includegraphics[width=6cm]{img9/trapezi-exer}
\end{center}
...
\begin{center}
	\includegraphics[width=0.3\textwidth]{img9/keops}
\end{center}
\answers{$x=211.681$}
...
\begin{center}
	...
	\begin{tabular}{|P{0.46\textwidth}|p{0.46\textwidth}|} \hline
		\rowcolor{lightgray} \textbf{Triangle} &   \textbf{Quadrat} \\ \hline
			...
			\begin{center} \includegraphics[width=0.25\textwidth]{img9/triangle} \end{center} &  \begin{center} 	$Area = \frac{b\cdot h}{2}$   \end{center}
		\end{tabular}
		& 
		\begin{tabular}{m{0.25\textwidth} m{0.2\textwidth}}
			\centering \includegraphics[width=0.25\textwidth]{img9/quadrat} &   \begin{center} $Area = c^2$ \end{center}
		\end{tabular}
		\\ \hline
		...
		\begin{tabular}{m{0.25\textwidth}m{0.2\textwidth}}
			\begin{center} \includegraphics[width=0.25\textwidth]{img9/rectangle} \end{center} &  \begin{center} 	$Area =b \cdot h$   \end{center}
		\end{tabular}
		& 
		\begin{tabular}{m{0.25\textwidth} m{0.2\textwidth}}
			\centering \includegraphics[width=0.25\textwidth]{img9/parallelogram} &   \begin{center} $Area =b\cdot h$ \end{center}
		\end{tabular}
		\\ \hline
		...
		\begin{tabular}{m{0.25\textwidth}m{0.2\textwidth}}
			\begin{center} \includegraphics[width=0.25\textwidth]{img9/rombe} \end{center} &  \begin{center} 	$Area = \frac{D\cdot d}{2}$   \end{center}
		\end{tabular}
		& 
		\begin{tabular}{m{0.21\textwidth} m{0.2\textwidth}}
			\centering \includegraphics[width=0.22\textwidth]{img9/trapezi} &   \begin{center} $Area = \frac{(B+b)\cdot h}{2}$ \end{center}
		\end{tabular}
		\\ \hline
		
			\rowcolor{lightgray} \textbf{Poligon regular} &   \textbf{Cercle} \\ \hline
		\begin{tabular}{m{0.2\textwidth}m{0.2\textwidth}}
			\begin{center} \includegraphics[width=0.23\textwidth]{img9/poligon} \end{center} &  \begin{center} 	$Area = \frac{P\cdot a_p}{2}$ \par $P$: perímetre \par $a_p$: apotema   \end{center}
		\end{tabular}
		& 
		\begin{tabular}{m{0.2\textwidth} m{0.2\textwidth}}
			\centering \includegraphics[width=0.2\textwidth]{img9/cercle} &   \begin{center} $Area = \pi\, R^2$ \par $L=2\pi \, R$ \end{center}
		\end{tabular}
		\\ \hline
		...
		\begin{tabular}{m{0.2\textwidth}m{0.2\textwidth}}
			\begin{center} \includegraphics[width=0.2\textwidth]{img9/sector} \end{center} &  \begin{center} 	$Area = \pi R^2 \frac{\alpha}{360}$ \par  $L = 2 \pi R \frac{\alpha}{360}$    \end{center}
		\end{tabular}
		& 
		\begin{tabular}{m{0.2\textwidth} m{0.2\textwidth}}
			\centering \includegraphics[width=0.2\textwidth]{img9/corona} &   \begin{center} $Area = \pi (R^2-r^2)$ \end{center}
		\end{tabular}
		\\ \hline
