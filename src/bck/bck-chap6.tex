...
\begin{iniaval}
	...
	\begin{tasks}(2)
		...
		\includegraphics[width=0.43\textwidth]{img6/tutifruti}
...
\begin{center}
\includegraphics[width=6cm]{img6/balanza02}
\end{center}
...
\end{minipage}
	...
	\begin{center}
	  \includegraphics[width=5cm]{img6/sistemagrafic}
	\end{center}
...
\begin{theorybox}
	...
	\begin{multicols}{3}
	\centering
		\includegraphics[width=3cm]{img6/scd}
		
		1 solució - Compatible determinat
		
		\includegraphics[width=3cm]{img6/si}
		
		Cap solució - Incompatible
		
		\includegraphics[width=3cm]{img6/sci}
...
\textit{x}${}^{2}$ $-$ 7\textit{x} + 10 = 0 \includegraphics*[bb=0 0 0.23in 0.17in, width=0.23in, height=0.17in, keepaspectratio=false]{img6/image4.png} (\textit{x} -- 2)$\cdot$(\textit{x} -- 5) = 0.
