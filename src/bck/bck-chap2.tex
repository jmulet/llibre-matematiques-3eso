...
\includegraphics[width=4cm]{img2/radicales}}{chap:potencies}
...
\begin{center}
	...
	\begin{theorybox}
		...
		\begin{minipage}{0.25\textwidth}
			\centering
			\includegraphics[width=0.7\textwidth]{img2/potencia}
		\end{minipage}
...
\begin{blueshaded}
	...
	\begin{minipage}{0.3\textwidth}
		\centering
		\includegraphics[width=0.9\textwidth]{img2/fx82ms-a}
	\end{minipage}
...
\centering
\vspace{2cm}
\includegraphics[width=0.6\textwidth]{img2/carbono14}
\end{minipage}
...
\begin{minipage}{0.3\textwidth}
	\centering
	\vspace{2cm}
	\includegraphics[width=0.6\textwidth]{img2/jupiter}
\end{minipage}
...
\begin{minipage}{0.2\textwidth}
	\centering
	\includegraphics[width=0.9\textwidth]{img2/radical}
\end{minipage}
...
\begin{blueshaded}
	...
	\begin{minipage}{0.3\textwidth}
		\centering
		\includegraphics[width=0.9\textwidth]{img2/fx82ms-b}
	\end{minipage}
...
\pagebreak
 ...
 \begin{theorybox}[Arrel d'una arrel]
 	...
 	\includegraphics[width=0.75cm]{img2/warning}  \textbf{Recorda que una arrel quadrada conté un índex 2:  $\sqrt{a}=\sqrt[ {\small 2}]{a}$}
 \end{theorybox}
